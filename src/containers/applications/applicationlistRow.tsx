...
export const ApplicationlistRow = (props: Props) => {
  ...
  const onClick = () => {
    navigation(`/applicationDetails/${props.applicationId}`, {
      state: { item: { ...props } },
    });
  };
    ...
    <div className="listItem" onClick={onClick}>
      ...
      <div className="listItemInfo">
        <div className="itemInfoRow">
          <Label
            style={{ fontFamily: "Exo-Medium", fontSize: "small" }}
          >{`${props.firstName} ${props.lastName} `}</Label>
        ...
        <div style={{ position: "relative" }}>
          <Label
            style={{
              ...
              top: "0px",
              right: "5px",
              color: statusColorRendarer(props.status as ApplicationStatusType),
            }}
          >
            {props.status}
          </Label>
