...
const defaultState ={authInfo:{role:null,token:null},login:(auth:AuthInfoType)=>{},logout:()=>{}}
export const AuthContext = React.createContext<AuthContextType>(defaultState);
export const Router =(props:Props)=>{
    const [logedIng,setLogedIn]= React.useState<{role:'admin'|'user'|null,token:string|null}>({role:null,token:null})
...
return (
    ...
    {logedIng.role!==null&& <TopBar/>}
       ...
       :<div className="publicRoute"> <PublicRoute/>
       </div>}
