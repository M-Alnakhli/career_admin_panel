...
export type ApplicationListAPIResType = {
  applications: ApplicationListItem[];
  totalRecords: number;
};

export type ApplicationListItem = ApplicationConfigration & {
...
export type CareerListAPIReqType = {
  offset: number;
  pageNumber: number;
} & CareerConfig;
export type CarearListAPIResType = {
  carears: Array<CareerConfig & { description?: string }>;
};

export type ApplicationUpdateAPIReqType = ApplicationConfigration & {
  applicationId?: string;
};
...
export type ApplicationConfigration = {
  firstName: string;
  lastName: string;
  age: number;
  posistion: string;
